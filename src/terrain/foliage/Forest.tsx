...
export function randomTreeGrid(clumpDiameter, midDiameter, minDist, maxDist, minScale, maxScale) {
  ...
  for (let i = 1; i < clumpDiameter - 1; i++) {
    ...
    for (let j = 1; j < clumpDiameter - 1; j++) {
      ...
      let x = i - midPos,
        y = j - midPos;
      if ((active && (x > midDiameter / 2 || x < midDiameter / -2)) || y > midDiameter / 2 || y < midDiameter / -2) {
